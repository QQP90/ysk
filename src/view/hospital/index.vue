  ...
  <div class="app-container">
    ...
    <div class="toolbar-bottom">
      <div class="action-box">
        <Button type="success" @click.native="handleNewHospital"
          ><span class="icon-xinzeng"></span>新增医院</Button
        >
      </div>
    ...
    <Modal
      :title="currentHospital.name + '：科室列表'"
      width="80%"
      height="80%"
      class="form-box"
      footer-hide
    ...
    >
      <departmentList ref="departmentView"></departmentList>
    </Modal>
    <Modal
      :title="hospitalFormTitle"
      width="80%"
      footer-hide
      v-model="isShowHospitalEditForm"
    >
      <hospitalForm
        ref="hospitalFormView"
    ...
    <Modal
      ...
      footer-hide
    >
      <doctorList :hospitalId="currentHospital.id"></doctorList>
    </Modal>
  </div>
</template>
...
import hospitalForm from "./editForm";
import departmentList from "../department/index";
import doctorList from "../doctor/doctor-list.vue";

export default {
  components: { expandInfo, departmentList, hospitalForm, doctorList },
  data() {
    return {
          ...
          render: (h, params) => {
            return h(
              ...
              [
                h("span", {
                  attrs: {
                    class: "icon-keshijianjie font-icon",
                    title: "管理科室"
                  },
                  on: {
                    click: () => {
                      ...
                      this.$refs.departmentView.loadData(this.currentHospital);
                    }
                  }
                }),
                h("span", {
                  ...
                  on: {
                    click: () => {
                      ...
                      this.currentHospital = Object.assign({}, params.row);
                      this.hospitalFormTitle = `编辑医院信息：${this.currentHospital.name}`;
                ...
                h("img", {
                  ...
                  on: {
                    click: () => {
                      this.$set(this.currentHospital, "id", params.row.id);
                      this.doctorFormTitle =
                        "【" + params.row.name + "】医生列表";
